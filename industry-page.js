...
(function(){
  ...
  +         '<a class="dd-item" href="../services/eor.html"><div class="dd-icon" style="background:var(--gold-lt);"><svg viewBox="0 0 24 24" stroke="var(--gold-dk)"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-5"/></svg></div><div><div class="dd-title">EOR</div><div class="dd-desc">Hire talent without opening a local entity</div></div></a>'
  +         '<a class="dd-item" href="../services/managed-team.html"><div class="dd-icon" style="background:var(--teal-lt);"><svg viewBox="0 0 24 24" stroke="var(--teal)"><path d="M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z"/></svg></div><div><div class="dd-title">Managed Team</div><div class="dd-desc">Dedicated teams with leads and support</div></div></a>'
  ...
  +         '<a class="dd-item" href="../services/eor.html#eor-pricing"><div class="dd-icon" style="background:var(--gold-lt);"><svg viewBox="0 0 24 24" stroke="var(--gold-dk)"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-5"/></svg></div><div><div class="dd-title">EOR pricing</div><div class="dd-desc">Jump to EOR plans, fees, and benefits</div></div></a>'
  +       '</div></div>'
  ...
  +   '<div class="mob-section"><div class="mob-section-title">Services</div><a class="mob-link" href="../services/direct-recruiting.html">Direct Recruiting</a><a class="mob-link" href="../services/eor.html">EOR</a><a class="mob-link" href="../services/managed-team.html">Managed Team</a><a class="mob-link" href="../services/strategic-partner-program.html">Strategic Partner Program</a></div>'
  ...
  +   '<a class="svc" href="../services/eor.html"><div class="svc-ic" style="background:var(--gold-lt);">'+svcIcon.eor+'</div><b>EOR &amp; Payroll</b><p>We become the legal employer — contracts, payroll, benefits and compliance, no local entity.</p></a>'
  +   '<a class="svc" href="../services/managed-team.html"><div class="svc-ic" style="background:var(--teal-lt);">'+svcIcon.mt+'</div><b>Managed Team</b><p>A dedicated team with a Nearwork lead running quality, coaching and day-to-day delivery.</p></a>'
